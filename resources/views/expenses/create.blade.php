<x-app-layout>
    <div class="max-w-4xl mx-auto">
        <h1 class="text-2xl md:text-3xl text-slate-800 font-bold mb-6">Record New Expense</h1>
        <div class="bg-white shadow-lg rounded-2xl p-6 border border-slate-200">
            <form action="{{ route('expenses.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mt-6 pt-6 border-t border-slate-200">
                    ...
                    <a href="{{ route('expenses.index') }}" class="ml-3 text-sm font-medium text-slate-600">Cancel</a>
                </div>
            </form>
        </div>
    </div>
